package com.janhen.leetcode.top100.recursion_dp_backtracking.solution300;
...
public class SolutionOP {
    ...
    public static void main(String[] args) {
        ...
        System.out.println((new SolutionOP()).lengthOfLIS(nums1));
        // 4

        // ---

        int nums2[] = {4, 10, 4, 3, 8, 9};
        System.out.println((new SolutionOP()).lengthOfLIS(nums2));
        // 3

        // ---

        int nums3[] = {2, 2};
        System.out.println((new SolutionOP()).lengthOfLIS(nums3));
        // 1

        // ---

        int nums4[] = {1, 3, 6, 7, 9, 4, 10, 5, 6};
        System.out.println((new SolutionOP()).lengthOfLIS(nums4));
        // 6
    }
}
