package com.janhen.coding.leetcode.algs.search.backtracking.subset.solution90;
...
class Solution2 {
    ...
    private void backtracking(int[] nums, int start, int size, List<Integer> list, boolean[] visited,
