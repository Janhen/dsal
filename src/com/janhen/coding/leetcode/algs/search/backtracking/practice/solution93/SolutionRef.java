...
class SolutionRef {
    ...
    // "010010"
    // ["0.10.0.10","0.100.1.0"]                    ["0.1.0.10","0.1.0.10","0.1.1.0","0.10.0.10","0.10.1.0","0.100.1
    // .0","1.0.0.10","1.0.1.0","1.0.1.0","10.0.1.0"]
                ...
                for (int k = 1; k <= 3; k++)
                    for (int l = 1; l <= 3; l++) {
                        if (i + j + k + l == s.length()) {
                            ...
                            if (a <= 255 && b <= 255 && c <= 255 && d <= 255) {              // ▲note: `0` as prefix
                                // then ignore
