package com.janhen.coding.leetcode.ds.tree.sm_two_sub_sequence_convert_path.solution100;
...
class SolutionDFS2 {
    ...
    public boolean isSameTree(TreeNode root1, TreeNode root2) {
        ...
        while (!s1.isEmpty() && !s2.isEmpty()) {
            ...
            if (s1.size() != s2.size())
                return false;           // must same size when left or right respectively to join
