...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        UF pathCompressionRecursion = new com.janhen.structures.unionFind.pathCompressionRecursion.UnionFind(size);
    ...
    public void testOptimize() {
        ...
        UF sizeOptimize = new com.janhen.structures.unionFind.sizeOptimize.UnionFind(size);
        UF rankOptimize = new com.janhen.structures.unionFind.rankOptimize.UnionFind(size);
        UF pathCompressionOptimize = new com.janhen.structures.unionFind.pathCompression.UnionFind(size);
        UF pathCompressionRecursionOptimize = new com.janhen.structures.unionFind.pathCompressionRecursion.UnionFind(size);
