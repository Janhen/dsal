package main.java.janhen.leetcode.array.sm_adv_sub_arr_seq_dp_range.solution621;
...
public class Solution_N {
    public int leastInterval(char[] tasks, int n) {
        ...
        // todo 按照Entry的value进行排序，转变成LinkedHashMap
//        freqs = freqs.entrySet().stream()
//                .sorted((o1,o2) -> o1.getValue() != o2.getValue() ? Integer.compare(o2.getValue(), o2.getValue()) : Character.compare(o1.getKey(), o2.getKey()))
//                .collect(
//                        Collectors.collectingAndThen(Collectors.toMap(e->e.getKey(), e->e.getValue(), LinkedHashMap::new)))
