package com.janhen.coding.leetcode.ds.array.sm_base_two_search_sort_matrix.solution15;
...
class Solution {
    public List<List<Integer>> threeSum(int[] nums) {
        ...
        for (int i = 0; i < nums.length - 2; i ++) {     // must have 3, scale of data
            if (i > 0 && nums[i] == nums[i -1]) continue;    // skip first and duplication
