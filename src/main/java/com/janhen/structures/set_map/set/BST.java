...
public class BST<E extends Comparable<E>> {
  ...
  /*
   * traverse not need modify tree structures and not use recursion
   */
  ...
  /*
   * 删除 BST min: - leaf node - not leaf node : let sub right tree as cur location
   */
  public E removeMin() {
    E minVal = minimum();
    root = removeMin(root);
  ...
  /*
   * delete BST max: - leaf node - not leaf node : let sub left tree as cur
   * location
   */
  ...
  private Node remove(Node node, E e) {
    ...
    if (cmp < 0) {
      ...
      /*
       * three condtion : - left is null(include leaf) - right is null(include leaf) -
